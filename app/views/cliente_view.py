...
class Cliente_terminal_view:
    ...
    def ler_dados_cliente(self):
        ...
        limite_credito = input("Digite seu limte de crédito: ")
    ...
    def exibir_clientes(self, clientes):
        ...
        print(f"{'ID' :<4} | {'NOME' :<20} | {'DATA DE NASCIMENTO' :<10} | {'LIMTE DE CREDITO' :<5}")
        print("-"*50)
        for c in clientes:
            print(f"{c.id :<4} | {c.nome :<20} | {c.data_nascimento :<10} | {c.limite_credito :<5}")
        print("-"*50)
